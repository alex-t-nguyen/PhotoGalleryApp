...
class MovePhotosDialog extends StatefulWidget {
  @override
  _MovePhotosDialogState createState() => _MovePhotosDialogState();
}

class _MovePhotosDialogState extends State<MovePhotosDialog> {
  ...
  dialogContent(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text('Select an album to move to', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
          DropdownButton(
